...
| 13 | *The "Miscellanies": (Entry Nos. a–z, aa–zz, 1–500)* | `MD/VOLUME13.md` | The local capture includes source files `001.html`–`005.html`. Page markers 110–112, 124, 151–152, 161–162, and 342–544 are absent from the source; the document does not add them artificially. Images are omitted. |
